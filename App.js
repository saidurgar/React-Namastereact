...
const Header = () => {
    return(
        ...
        <div className="logo-container">
            <img 
            className="logo" 
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHs7fXUlfjWTdGIVsRVfltF6hPDm-ZH_2vOw&s"
            />
        </div>
...
const Body=() => {
    return(
        ...
        <RestauarantCard  key = {restaurant.data.id} resData={restaurant}/>
        ))}
